# Barnsley, Penistone & Stocksbridge — Leafletting Map

A canvassing and leafletting tracker for Barnsley, Penistone and Stocksbridge. Volunteers can view road-level status, plan routes, and mark progress in real time via a Google Sheets backend.
...
Live: **https://daemeous.github.io/barnsley/**
